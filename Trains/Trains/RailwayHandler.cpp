...
// Function to set runWithDefaultInterval which determines how RailwayHandler print event information.
void RailwayHandler::setRunWithDefaultInterval(bool value) {
	runWithDefaultInterval = value;
}
